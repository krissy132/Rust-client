...
/// Precomputed variants for all 21 PieceShapes — calculated once at startup, then accessed
/// via `SHAPE_VARIANTS[shape as usize]`. Eliminates the expensive per-call recomputation
/// of shape transformations in move-generation hot paths.
static SHAPE_VARIANTS: LazyLock<[Vec<ShapeVariant>; PieceShape::TOTAL]> = LazyLock::new(|| {
    [
        PieceShape::Mono.variants_dyn(),
        PieceShape::Domino.variants_dyn(),
        PieceShape::TrioL.variants_dyn(),
        PieceShape::TrioI.variants_dyn(),
        PieceShape::TetroO.variants_dyn(),
        PieceShape::TetroT.variants_dyn(),
        PieceShape::TetroI.variants_dyn(),
        PieceShape::TetroL.variants_dyn(),
        PieceShape::TetroZ.variants_dyn(),
        PieceShape::PentoL.variants_dyn(),
        PieceShape::PentoT.variants_dyn(),
        PieceShape::PentoV.variants_dyn(),
        PieceShape::PentoS.variants_dyn(),
        PieceShape::PentoZ.variants_dyn(),
        PieceShape::PentoI.variants_dyn(),
        PieceShape::PentoP.variants_dyn(),
        PieceShape::PentoW.variants_dyn(),
        PieceShape::PentoU.variants_dyn(),
        PieceShape::PentoR.variants_dyn(),
        PieceShape::PentoX.variants_dyn(),
        PieceShape::PentoY.variants_dyn(),
    ]
});
...
impl PieceShape {
    ...
    /// Returns all variants of this shape (cached statically at startup).
    pub fn variants(&self) -> &'static [ShapeVariant] {
        &SHAPE_VARIANTS[*self as usize]
    }
    ...
    /// Dynamic version (used only during static initialization) — returns a Vec<ShapeVariant>.
    /// This is the exact same logic as Kotlin's pieceShape.variants map logic.
    fn variants_dyn(self) -> Vec<ShapeVariant> {
